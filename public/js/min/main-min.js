$(function() {
    ...
    }), "themeforest.net" === window.location.hostname ? $("#buyBtn").attr("href", "http://themeforest.net/item/fluxo-social-media-marketing-template/24039688?ref=weboth") : $("#buyBtn").attr("href", "#0")
});